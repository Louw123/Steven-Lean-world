...
However, when meeting them, you quickly realize that they are working on something. They are working on the something in the 'LE∀N: theorem prover'
...
However, I want you to know what LE∀N Is


LE∀N is a proof asistant and a flexible language that allows you to create proofs, by using tactics to try and prove the proof.
